...
void CHNMain(void)
{
	...
	win = api_openwin(winbuf, 336, 261, -1, "インベーダーゲーム");
	api_boxfilwin(win, 6, 27, 329, 254, 0);
	timer = api_alloctimer();
	api_inittimer(timer, 128);

	high = 0;
	putstr(win, winbuf, 22, 0, 7, "SCORE:00000000");

restart:
	score = 0;
	point = 1;
	putstr(win, winbuf,  4, 0, 7, "HISCORE:00000000");
	movewait0 = 20;
	fx = 18;
...
next_group:
	...
	/* GAME OVER */
	putstr(win, winbuf, 15, 6, 1, "ゲームオーバー");
